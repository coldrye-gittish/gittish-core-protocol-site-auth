# gittish-core-protocol-site-auth

This package defines the service interface that is responsible for managing the
ACLs of the site and also for authorizing the operations on the site based on
these ACLs.

The service supports the following use cases

* check whether a given actor has the specified permission
* retrieve the ACL
* grant, deny and revoke permissions for specific actors
* manage existing site credentials
...
```
cd <WORKSPACE_ROOT>/gittish-core-protocol-site-auth
./configure
```
